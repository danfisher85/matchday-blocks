...
= 1.1.3 =
* Fix - Block styles are now loaded inside the iframed block editor, so block previews are styled again. WordPress 7.1 always renders the post editor in an iframe, where stylesheets enqueued via `enqueue_block_editor_assets` are not applied.
* Tweak - Tested and confirmed compatible with WordPress 7.1.
...
= 1.1.3 =
Fixes unstyled block previews in the WordPress 7.1 block editor. Update recommended for all users.
